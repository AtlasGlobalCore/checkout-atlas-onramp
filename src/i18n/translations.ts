...
const translations = {
  pt: {
    ...
    'payment.method_demo': 'Método de Pagamento (Demo)',
    ...
    'payment.demo_mode': 'Modo demonstração — nenhum pagamento real será processado',
  ...
  en: {
    ...
    'payment.method_demo': 'Payment Method (Demo)',
    ...
    'payment.demo_mode': 'Demo mode — no real payment will be processed',
  ...
  es: {
    ...
    'payment.method_demo': 'Método de Pago (Demo)',
    ...
    'payment.demo_mode': 'Modo demostración — no se procesará ningún pago real',
  ...
  fr: {
    ...
    'payment.method_demo': 'Méthode de Paiement (Démo)',
    ...
    'payment.demo_mode': 'Mode démonstration — aucun paiement réel ne sera traité',
