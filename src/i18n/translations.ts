...
const translations = {
  pt: {
    ...
    'payment.redirecting': 'A redirecionar para o processador de pagamento seguro...',
  ...
  en: {
    ...
    'payment.redirecting': 'Redirecting to secure payment processor...',
  ...
  es: {
    ...
    'payment.redirecting': 'Redirigiendo al procesador de pago seguro...',
  ...
  fr: {
    ...
    'payment.redirecting': 'Redirection vers le processeur de paiement sécurisé...',
